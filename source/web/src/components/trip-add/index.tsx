  ...
  return (
    <section className={styles.tripAddSection}>
      <div className={`${styles.tripAddContent} container`}>
        <p className={styles.tripAddDescription}>
          {tripAddData[tripAddStep].label}
        </p>
        <h1 className={styles.TripAddTitle}>
          {tripAddData[tripAddStep].title}
        </h1>
        <Link href={"#"} className={styles.actionButton}>
          Mais informações
        </Link>
        <div
          className={styles.tripAddImageContainer}
          style={{ transform: `translate(${tripAddStep * 1040}px)` }}
        >
